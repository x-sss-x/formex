...
export default function Format03({ data }: { data: Format03Data }) {
  ...
  return (
    ...
    >
      {/* ── HEADER ── */}
      <table style={{ width: "100%", borderCollapse: "collapse", border: "1px solid black", marginBottom: "9pt" }}>
        <tbody>
          <tr>
            <td style={{ width: "64pt", border: "1px solid black", textAlign: "center", verticalAlign: "middle", padding: "3pt" }}>
              <Image
            ...
            <td style={{ width: "74pt", border: "1px solid black", verticalAlign: "top", padding: "4pt 5pt", fontSize: "8.5pt" }}>
      ...
      {/* ── CALENDAR TABLE ── */}
      <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "8.5pt", marginBottom: "7pt" }}>
        <thead>
          <tr>
            <th rowSpan={2} style={{ border: "1px solid black", textAlign: "center", padding: "3pt 4pt", width: "28pt", fontWeight: "bold" }}>Week</th>
            <th rowSpan={2} style={{ border: "1px solid black", textAlign: "center", padding: "3pt 4pt", width: "52pt", fontWeight: "bold" }}>Day</th>
            <th rowSpan={2} style={{ border: "1px solid black", textAlign: "center", padding: "3pt 4pt", width: "44pt", fontWeight: "bold" }}>Date</th>
            ...
            return DAYS.map((day, dayIdx) => {
              ...
              return (
                <tr key={`${week}-${day}`} style={{ backgroundColor: isSunday ? "#BDD7EE" : "transparent" }}>
                  {dayIdx === 0 && (
                    <td rowSpan={7} style={{ border: "1px solid black", textAlign: "center", verticalAlign: "middle", padding: "3pt", fontWeight: "normal", fontSize: "9pt" }}>
                      {week}
                    </td>
                  )}
                  <td style={{ border: "1px solid black", padding: "2.5pt 5pt" }}>{day}</td>
                  <td style={{ border: "1px solid black", padding: "2.5pt 5pt", textAlign: "center" }}>{ev?.date ?? ""}</td>
                  <td style={{ border: "1px solid black", padding: "2.5pt 5pt", wordBreak: "break-word" }}>{ev?.morningSession ?? ""}</td>
                  <td style={{ border: "1px solid black", padding: "2.5pt 5pt", wordBreak: "break-word" }}>{ev?.afternoonSession ?? ""}</td>
                </tr>
              );
            });
          })}
      ...
      {/* ── NOTE & SIGNATURE ── */}
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginTop: "8pt" }}>

...
/** Calendar variant — same data shape as Format 03; styled heading only differs. */
export default function Format04({ data }: Format04Props) {
  ...
  return (
    ...
    >
      <h1 className="border-b border-black pb-2 text-sm font-bold">
        Format 04 — Academic calendar (variant)
      </h1>
      ...
      <p className="mt-4 text-[9pt] font-semibold">Events ({events.length})</p>
